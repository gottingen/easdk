...
namespace easdk {
    ...
    /**
     * @brief ConfigWatchEntity It is used by the ConfigWatcher to store the config watch information.
    */
    ...
    /**
     * @brief ConfigWatcher is used to download config files from the meta server.
    ...
    public:
        ...
        ~ConfigWatcher() = default;
        /**
         * @brief init is used to initialize the ConfigWatcher. It must be called before using the ConfigWatcher.
         * @return Status::OK if the ConfigWatcher was initialized successfully. Otherwise, an error status is returned.
         */
        turbo::Status initialize(const std::vector<std::string> &servers);

        /**
         * @brief start is used to start the ConfigWatcher.
         * @return void
        ...
        /**
         * @brief join is used to wait for the ConfigWatcher to stop.
         * @return void
