...
namespace easdk::cli {
    ...
    struct DiscoveryCmd {
        ...
        make_discovery_add_instance(eapi::sirius::DiscoveryManagerRequest *req);

        [[nodiscard]] static turbo::Status
        make_discovery_remove_instance(eapi::sirius::DiscoveryManagerRequest *req);

        [[nodiscard]] static turbo::Status
        make_discovery_update_instance(eapi::sirius::DiscoveryManagerRequest *req);

        [[nodiscard]] static turbo::Status
        make_discovery_list_instance(eapi::sirius::DiscoveryQueryRequest *req);
        ...
        static collie::table::Table show_query_instance_list_response(const eapi::sirius::DiscoveryQueryResponse &res);
        static collie::table::Table show_query_instance_info_response(const eapi::sirius::DiscoveryQueryResponse &res);
    };
}  // namespace easdk::cli
