...
namespace easdk::sirius {
    ...
    public:
         ...
         */
        turbo::Status add_config(const eapi::sirius::ConfigInfo &config);
         ...
         */
        turbo::Status
        get_config(const std::string &name, const collie::ModuleVersion &version, eapi::sirius::ConfigInfo &config);
         ...
         * @return Status::OK if the config was received successfully. Otherwise, an error status is returned. 
         */
        turbo::Status get_config(const std::string &name, eapi::sirius::ConfigInfo &config);
    ...
    private:
         ...
         * @return
         */
        turbo::Status write_config_file(const std::string &dir, const eapi::sirius::ConfigInfo &config);
         ...
         * @return
         */
        turbo::Status remove_config_file(const std::string &dir, const eapi::sirius::ConfigInfo &config);
         ...
         * @return
         */
        std::string make_cache_file_path(const std::string &dir, const eapi::sirius::ConfigInfo &config);

        /**
         *
         * @param config
         */
        void do_add_config(const eapi::sirius::ConfigInfo &config);

    private:
        typedef turbo::flat_hash_map<std::string, std::map<collie::ModuleVersion, eapi::sirius::ConfigInfo>> CacheType;
