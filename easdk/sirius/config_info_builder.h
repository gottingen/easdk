...
namespace easdk::sirius {
    ...
    public:
        ...
        explicit ConfigInfoBuilder(eapi::sirius::ConfigInfo *info);

        /**
         * @brief set up ConfigInfo pointer for building
         * @param info
         */
        void set_info(eapi::sirius::ConfigInfo *info);
         ...
         * @return status.ok() if success else return the reason of parse fail.
         */
        turbo::Status build_from_file(const std::string &name, const std::string &file, const eapi::sirius::Version &version,
                                      const eapi::sirius::ConfigType &type = eapi::sirius::CF_JSON);
         ...
         * @return status.ok() if success else return the reason of build fail.
         */
        turbo::Status build_from_content(const std::string &name, const std::string &content, const eapi::sirius::Version &version,
                                         const eapi::sirius::ConfigType &type = eapi::sirius::CF_JSON);
        /**
         * @brief build ConfigInfo by parameters, the config store in content
         * @param name [input] config name
    ...
    private:
        eapi::sirius::ConfigInfo *_info{nullptr};
    };
}  // namespace client
