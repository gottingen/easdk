...
namespace easdk::sirius {
    ...
    public:
        ...
        explicit ServletInstanceBuilder(eapi::sirius::ServletInfo *ins);
    ...
    public:
         ...
         */
        void set(eapi::sirius::ServletInfo *ins);
    ...
    private:
        eapi::sirius::ServletInfo *_instance;
    };
}  // namespace easkd::sirius
